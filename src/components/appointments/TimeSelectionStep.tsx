...
function TimeSelectionStep({selectedDentistId,selectedDate,selectedTime,selectedType,onBack,onContinue,onDateChange,onTimeChange,onTypeChange}:TimeSelectionStepProps) {
