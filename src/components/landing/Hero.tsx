          ...
          <div className='grid lg:grid-cols-2 gap-16 items-center'>
            ...
            <div className='space-y-10'>
              ...
              <div className="space-y-6">
                {/* Badge */}
                <div className='inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/10 to-primary/5 rounded-full border-primary/20 backdrop-blur-sm'>
                  <div className='w-2 h-2 bg-primary rounded-full animate-pulse'></div>
                  <span className='text-sm font-medium text-primary'>AI-Powered Denteal Assistent</span>
                </div>
                {/* /Badge */}
            ...
            <div className='relative lg:pl-8'>
              ...
              <Image src={'/hero.png'} width={600} height={600} alt='dentwise ai' className='w-full h-auto'/>
