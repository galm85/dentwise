import { useGetAppointments, useUpdateAppointmantStatus } from "@/hooks/use-appointments"
...
function RecentAppointments() {
    ...
    const updateAppointmetMutation = useUpdateAppointmantStatus();
    ...
    const handleToggleAppointmentStatus = (appointmentId:string)=>{
        ...
        updateAppointmetMutation.mutate({id:appointmentId,status:newStatus});
    }
    ...
    const getStatusBadge = (status:string) =>{
        switch(status){
            ...
            case "COMPLETED":
                return <Badge className="bg-blue-100 text-green-800 hover:bg-green-100">COMPLETED</Badge>
            default:
  ...
  return (
    <Card>
        <CardHeader>
            ...
            <CardDescription>Monotor and manage all patients appointments</CardDescription>
        </CardHeader>
